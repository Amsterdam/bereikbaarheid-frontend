...
describe('RoadSectionDetails', () => {
  ...
  it('renders correctly', () => {
    render(withAppContext(<RoadSectionDetails properties={roadSectionObstructions.features[0].properties} />))
  ...
  it('shows road obstructions', () => {
    ...
    expect(screen.getAllByRole('heading', { level: 2 })[0]).toHaveTextContent('Stremmingen')

    expect(screen.getAllByRole('columnheader', { name: 'Werkzaamheden' })).toHaveLength(1)

    expect(
      screen.getByRole('cell', {
        name: roadSectionObstructions.features[0].properties.traffic_obstructions[0].activity,
      })
    ).toBeInTheDocument()
  })
