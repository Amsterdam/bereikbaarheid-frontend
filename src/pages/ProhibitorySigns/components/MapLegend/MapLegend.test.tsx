...
describe('MapLegend', { timeout: 30000 }, () => {
  it('renders correctly', async () => {
    ...
    const addressCheckbox = await screen.findByLabelText('Ik wil een adres invoeren')
    if (addressCheckbox.checked) {
      await user.click(addressCheckbox)
    }
    await user.click(await screen.getByText('Volgende', { selector: 'button' }))
  ...
  //   const buttonZoomIn = await screen.getByTitle('Inzoomen')
